...
TEST(PrimeTest, PrimeAttributes) {
    ...
    EXPECT_TRUE(prime.general_ability());  // Assuming this should return true
...
TEST(BumblebeeTest, BumblebeeAttributes) {
    ...
    EXPECT_TRUE(bumblebee.infantry_ability());  // Assuming this should return true
...
TEST(LiegeMaximoTest, LiegeMaximoAttributes) {
    ...
    EXPECT_TRUE(liege_maximo.solo_ability());  // Assuming this should return true
